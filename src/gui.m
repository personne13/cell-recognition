...
% Last Modified by GUIDE v2.5 27-Nov-2018 18:42:06
...
if isfield(handles,'OpenedFolder')
    ...
    currentImage = imread(strcat(handles.OpenedFolder,'/', fileName{1}));
    imshow(currentImage,'Parent',handles.AxesMainCanvas);
else
